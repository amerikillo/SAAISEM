 ...
 * @author wence
 */
public class ConectionDB_Inventarios {
...
//CONSTRUCTORES
    ...
    public ConectionDB_Inventarios(String usuario, String clave, String url, String driverClassName) {
    ...
    public ConectionDB_Inventarios() {
